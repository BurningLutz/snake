...
(function($PS) {
  ...
  var towards = function (dir) {
      return function (v) {
          if (dir instanceof W && v.direction instanceof S) {
              return v;
          };
          if (dir instanceof S && v.direction instanceof W) {
              return v;
          };
          if (dir instanceof A && v.direction instanceof D) {
              return v;
          };
          if (dir instanceof D && v.direction instanceof A) {
              return v;
          };
          return {
              direction: dir,
  ...
  var toVector = function (v) {
      if (v instanceof W) {
          return Data_Common.uvecW;
      };
      if (v instanceof S) {
          return Data_Common.uvecS;
      };
      if (v instanceof A) {
          return Data_Common.uvecA;
      };
      if (v instanceof D) {
          return Data_Common.uvecD;
      };
  ...
  var canBiteItself = function (v) {
      ...
      var m = Data_Functor.flap(Data_Functor.functorFn)(Data_Functor.flap(Data_Functor.functorFn)(Data_Array.foldM(Data_Maybe.monadMaybe))(toVector(v1.head)))(v1.tail)(function (acc) {
          return function (p) {
              var $36 = Data_Eq.eq(Data_Tuple.eqTuple(Data_Eq.eqInt)(Data_Eq.eqInt))(acc)(new Data_Tuple.Tuple(0, 0));
              if ($36) {
                  return Data_Maybe.Nothing.value;
              };
      ...
      throw new Error("Failed pattern match at Data.Snake (line 102, column 3 - line 104, column 21): " + [ m.constructor.name ]);
  };
  exports["W"] = W;
  exports["S"] = S;
  exports["A"] = A;
...
(function($PS) {
  ...
  var Data_Unit = $PS["Data.Unit"];
  var Data_Variant = $PS["Data.Variant"];                
  var MeatSpawner = function (Monad0, spawnMeat) {
      this.Monad0 = Monad0;
  ...
  var $$new = function (dictMeatSpawner) {
      return function (w) {
          return function (h) {
              return function (dir) {
                  return function (p) {
                      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(dictMeatSpawner.Monad0()))(Data_GamingArea.gamingArea(dictMeatSpawner.Monad0())(w)(h))(function (v) {
                          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(dictMeatSpawner.Monad0()))(Control_Monad_Trans_Class.lift(Control_Monad_Except_Trans.monadTransExceptT)(dictMeatSpawner.Monad0())(spawnMeat(dictMeatSpawner)(w)(h)))(function (v1) {
                              var snake = Data_Snake.makeSnakeTowards(dir)(p);
                              return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(dictMeatSpawner.Monad0()))({
                                  gamingArea: v,
                                  snake: snake,
                                  meat: v1
                              });
  ...
  var next = function (dictMeatSpawner) {
      return function (v) {
          var v1 = Data_GamingArea.dimension(v.gamingArea);
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(dictMeatSpawner.Monad0()))(Control_Monad_Trans_Class.lift(Control_Monad_Except_Trans.monadTransExceptT)(dictMeatSpawner.Monad0())((function () {
              var $12 = Data_Snake.canEat(v.snake)(v.meat);
              if ($12) {
                  return Control_Bind.bind((dictMeatSpawner.Monad0()).Bind1())(spawnMeat(dictMeatSpawner)(v1.value0)(v1.value1))(function (v2) {
                      return Control_Applicative.pure((dictMeatSpawner.Monad0()).Applicative0())(new Data_Tuple.Tuple(Data_Snake.grow(v.snake), v2));
                  });
              };
              return Control_Applicative.pure((dictMeatSpawner.Monad0()).Applicative0())(new Data_Tuple.Tuple(Data_Snake.move(v.snake), v.meat));
          })()))(function (v2) {
              var $16 = !(Data_Common["between'"](Data_Ord.ordInt)(v2.value0.head.value0)(new Data_Tuple.Tuple(0, v1.value0 - 1 | 0)) && Data_Common["between'"](Data_Ord.ordInt)(v2.value0.head.value1)(new Data_Tuple.Tuple(0, v1.value1 - 1 | 0))) || Data_Snake.canBiteItself(v2.value0);
              if ($16) {
                  return Control_Monad_Error_Class.throwError(Control_Monad_Except_Trans.monadThrowExceptT(dictMeatSpawner.Monad0()))(gameOver);
              };
              return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(dictMeatSpawner.Monad0()))({
  ...
  exports["MeatSpawner"] = MeatSpawner;
  exports["new"] = $$new;
  exports["next"] = next;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.5
  "use strict";
  $PS["Data.Renderer.Class"] = $PS["Data.Renderer.Class"] || {};
  var exports = $PS["Data.Renderer.Class"];
  var Renderer = function (Monad0, render) {
      this.Monad0 = Monad0;
      this.render = render;
  };
...
(function($PS) {
  // Generated by purs version 0.13.5
  "use strict";
  $PS["Data.AppM"] = $PS["Data.AppM"] || {};
  var exports = $PS["Data.AppM"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Except_Trans = $PS["Control.Monad.Except.Trans"];
  var Control_Monad_Trans_Class = $PS["Control.Monad.Trans.Class"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Game = $PS["Data.Game"];
  var Data_Renderer_Class = $PS["Data.Renderer.Class"];
  var Data_Snake = $PS["Data.Snake"];
  var Data_Symbol = $PS["Data.Symbol"];
  var Data_Tuple = $PS["Data.Tuple"];
  var Record = $PS["Record"];                
  var Suspendable = function (Monad0, suspend) {
      this.Monad0 = Monad0;
      this.suspend = suspend;
  };
  var Setup = function (Monad0, setup) {
      this.Monad0 = Monad0;
      this.setup = setup;
  };
  ...
  var Interactive = function (Monad0, onKey) {
      this.Monad0 = Monad0;
      this.onKey = onKey;
  };
  var GameProvider = function (Monad0, $$new, read, write) {
      this.Monad0 = Monad0;
      this["new"] = $$new;
      this.read = read;
      this.write = write;
  ...
  var appM = function (dictGameProvider) {
      return function (dictMeatSpawner) {
          return function (dictRenderer) {
              return function (dictSetup) {
                  return function (dictInteractive) {
                      return function (dictSuspendable) {
                          return function (dictQuitable) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(dictGameProvider.Monad0()))(Control_Monad_Trans_Class.lift(Control_Monad_Except_Trans.monadTransExceptT)(dictGameProvider.Monad0())(setup(dictSetup)))(function () {
                                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(dictGameProvider.Monad0()))(Data_Game["new"](dictMeatSpawner)(80)(30)(Data_Snake.D.value)(new Data_Tuple.Tuple(40, 25)))(function (v) {
                                      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(dictGameProvider.Monad0()))(Control_Monad_Trans_Class.lift(Control_Monad_Except_Trans.monadTransExceptT)(dictGameProvider.Monad0())($$new(dictGameProvider)(v)))(function (v1) {
                                          var towards$prime = function (dir) {
                                              return Control_Bind.bind((dictGameProvider.Monad0()).Bind1())(Data_Functor.mapFlipped((((dictGameProvider.Monad0()).Bind1()).Apply0()).Functor0())(read(dictGameProvider)(v1))(Record.modify(new Data_Symbol.IsSymbol(function () {
                                                  return "snake";
                                              }))()()(Data_Symbol.SProxy.value)(Data_Snake.towards(dir))))(write(dictGameProvider)(v1));
                                          };
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(dictGameProvider.Monad0()))(Control_Monad_Trans_Class.lift(Control_Monad_Except_Trans.monadTransExceptT)(dictGameProvider.Monad0())(onKey(dictInteractive)("w")(towards$prime(Data_Snake.W.value))))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(dictGameProvider.Monad0()))(Control_Monad_Trans_Class.lift(Control_Monad_Except_Trans.monadTransExceptT)(dictGameProvider.Monad0())(onKey(dictInteractive)("s")(towards$prime(Data_Snake.S.value))))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(dictGameProvider.Monad0()))(Control_Monad_Trans_Class.lift(Control_Monad_Except_Trans.monadTransExceptT)(dictGameProvider.Monad0())(onKey(dictInteractive)("a")(towards$prime(Data_Snake.A.value))))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(dictGameProvider.Monad0()))(Control_Monad_Trans_Class.lift(Control_Monad_Except_Trans.monadTransExceptT)(dictGameProvider.Monad0())(onKey(dictInteractive)("d")(towards$prime(Data_Snake.D.value))))(function () {
                                                          var tick = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(dictGameProvider.Monad0()))(Control_Monad_Trans_Class.lift(Control_Monad_Except_Trans.monadTransExceptT)(dictGameProvider.Monad0())(read(dictGameProvider)(v1)))(function (v2) {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(dictGameProvider.Monad0()))(Control_Monad_Trans_Class.lift(Control_Monad_Except_Trans.monadTransExceptT)(dictGameProvider.Monad0())(Data_Renderer_Class.render(dictRenderer)(v2)))(function () {
                                                                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(dictGameProvider.Monad0()))(Data_Game.next(dictMeatSpawner)(v2))(function (v3) {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(dictGameProvider.Monad0()))(Control_Monad_Trans_Class.lift(Control_Monad_Except_Trans.monadTransExceptT)(dictGameProvider.Monad0())(Control_Bind.discard(Control_Bind.discardUnit)((dictGameProvider.Monad0()).Bind1())(write(dictGameProvider)(v1)(v3))(function () {
                                                                          return suspend(dictSuspendable);
                                                                      })))(function () {
                                                                          return tick;
                                                                      });
                                                                  });
...
(function($PS) {
  // Generated by purs version 0.13.5
  "use strict";
  $PS["Data.Renderer.Tty"] = $PS["Data.Renderer.Tty"] || {};
  var exports = $PS["Data.Renderer.Tty"];
  ...
  var writeTtyString = function (s) {
      return function (cb) {
          return Data_Functor["void"](Effect.functorEffect)(Node_Stream.writeString(Node_Process.stdout)(Node_Encoding.UTF8.value)(s)(cb));
      };
  };
  ...
  var placeSnake = function (v) {
      ...
      var $25 = placeObjectAt("@")(v.head);
      return function ($26) {
          return placeBody($25($26));
      };
  };
  ...
  var render = function (v) {
      return function (cb) {
          ...
          var outputString = Ansi_Codes.escapeCodeToString(new Ansi_Codes.Position(0, 0)) + Data_String_Common.joinWith("")(Data_Functor.map(Data_Functor.functorArray)((function () {
              var $27 = Data_String_Common.joinWith("");
              return function ($28) {
                  return (function (v2) {
                      return v2 + Ansi_Codes.escapeCodeToString(new Ansi_Codes.NextLine(1));
                  })($27($28));
              };
          })())(areaMap));
          return writeTtyString(outputString)(cb);
      };
  };
  exports["render"] = render;
})(PS);
...
(function($PS) {
  ...
  var Control_Monad_Except_Trans = $PS["Control.Monad.Except.Trans"];
  var Control_Monad_Reader_Trans = $PS["Control.Monad.Reader.Trans"];
  var Data_AppM = $PS["Data.AppM"];
  var Data_Either = $PS["Data.Either"];
  var Data_Function = $PS["Data.Function"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Game = $PS["Data.Game"];
  var Data_Renderer_Class = $PS["Data.Renderer.Class"];
  var Data_Renderer_Tty = $PS["Data.Renderer.Tty"];
  var Data_Show = $PS["Data.Show"];
  var Data_Tuple = $PS["Data.Tuple"];
  var Data_Unit = $PS["Data.Unit"];
  ...
  var quit$prime = Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Data_Functor["void"](Effect.functorEffect)(Node_Process.exit(0)));
  ...
  var quitableAppM = new Data_AppM.Quitable(function () {
      return monadAppM;
  }, Effect_Class.liftEffect(monadEffectAppM)(quit$prime));
  var monadAffAppM = Effect_Aff_Class.monadAffReader(Effect_Aff_Class.monadAffAff);
  var rendererAppM = new Data_Renderer_Class.Renderer(function () {
      return monadAppM;
  }, function (s) {
      return Effect_Aff_Class.liftAff(monadAffAppM)(Effect_Aff.makeAff(function (cb) {
          return function __do() {
              Data_Functor["void"](Effect.functorEffect)(Data_Renderer_Tty.render(s)(cb(Control_Applicative.pure(Data_Either.applicativeEither)(Data_Unit.unit))))();
              return Effect_Aff.nonCanceler;
          };
      }));
  });
  var suspendableAppM = new Data_AppM.Suspendable(function () {
      return monadAppM;
  }, Effect_Aff_Class.liftAff(monadAffAppM)(Effect_Aff.delay(100.0)));
  var meatSpawnerAppM = new Data_Game.MeatSpawner(function () {
      return monadAppM;
  }, function (w) {
      return function (h) {
          return Effect_Class.liftEffect(monadEffectAppM)(Control_Apply.lift2(Effect.applyEffect)(Data_Tuple.Tuple.create)(Effect_Random.randomInt(0)(w - 1 | 0))(Effect_Random.randomInt(0)(h - 1 | 0)));
      };
  });
  var interactiveAppM = new Data_AppM.Interactive(function () {
      return monadAppM;
  }, function (k) {
      return function (p) {
          return Effect_Class.liftEffect(monadEffectAppM)(Node_Stream.onDataString(Node_Process.stdin)(Node_Encoding.UTF8.value)(function (s) {
              return Control_Applicative.when(Effect.applicativeEffect)(k === s)(Effect_Aff.launchAff_(runAppM(p)));
          }));
      };
  });
  var gameProviderAppM = new Data_AppM.GameProvider(function () {
      return monadAppM;
  }, (function () {
      var $3 = Effect_Class.liftEffect(monadEffectAppM);
      return function ($4) {
          return $3(Effect_Ref["new"]($4));
      };
  })(), (function () {
      var $5 = Effect_Class.liftEffect(monadEffectAppM);
      return function ($6) {
          return $5(Effect_Ref.read($6));
      };
  })(), function (r) {
      var $7 = Effect_Class.liftEffect(monadEffectAppM);
      var $8 = Data_Function.flip(Effect_Ref.write)(r);
      return function ($9) {
          return $7($8($9));
      };
  });
  ...
  var setupAppM = new Data_AppM.Setup(function () {
      return monadAppM;
  }, Control_Bind.discard(Control_Bind.discardUnit)(bindAppM)(Effect_Class.liftEffect(monadEffectAppM)(Data_Util.setRawMode(Node_Process.stdin)(true)))(function () {
      return Data_AppM.onKey(interactiveAppM)("\x03")(Data_AppM.quit(quitableAppM));
  }));
  var main = Effect_Aff.launchAff_(runAppM(Control_Monad_Except_Checked.safe(functorAppM)(Control_Monad_Except_Checked.handleError()()()(monadAppM)({
      ...
      gameOver: function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(monadAppM))(Effect_Class_Console.logShow(Control_Monad_Except_Trans.monadEffectExceptT(monadEffectAppM))(Data_Show.showString)("Game Over"))(function () {
              return Effect_Class.liftEffect(Control_Monad_Except_Trans.monadEffectExceptT(monadEffectAppM))(quit$prime);
          });
      }
  })(Data_AppM.appM(gameProviderAppM)(meatSpawnerAppM)(rendererAppM)(setupAppM)(interactiveAppM)(suspendableAppM)(quitableAppM)))));
  ...
  exports["meatSpawnerAppM"] = meatSpawnerAppM;
  exports["gameProviderAppM"] = gameProviderAppM;
  exports["suspendableAppM"] = suspendableAppM;
  exports["rendererAppM"] = rendererAppM;
  exports["interactiveAppM"] = interactiveAppM;
  exports["quitableAppM"] = quitableAppM;
  exports["setupAppM"] = setupAppM;
})(PS);
PS["Main"].main();